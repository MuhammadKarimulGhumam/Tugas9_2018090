...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        exlistview = findViewById(R.id.CoinList);
        getPokemons();
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_profile) {
                    ...
                    Intent a = new Intent(MainActivity4.this, ActivityMain2.class);
                    startActivity(a);
                } else if (id == R.id.nav_settings) {
                    Intent a = new Intent(MainActivity4.this, ActivityMain3.class);
                    startActivity(a);
        ...
        call.enqueue(new Callback<RestApi>() {
            ...
            public void onResponse(Call<RestApi> call, Response<RestApi> response) {
                ...
                exlistview.setAdapter(new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1, onePokemon));
            }
            @Override
